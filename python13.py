...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.pushButton_10.clicked.connect(self.show)
		...
		self.pushButton_16.clicked.connect(self.show)
		...
		self.pushButton_23.clicked.connect(self.show)
		self.pushButton_19.clicked.connect(self.show)
		self.pushButton_22.clicked.connect(self.show)
		
		self.pushButton_21.clicked.connect(self.show)
		self.pushButton_24.clicked.connect(self.show)
		self.pushButton_17.clicked.connect(self.show)
